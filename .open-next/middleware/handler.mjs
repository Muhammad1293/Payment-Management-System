...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      e.s(["config", 0, { matcher: ["/((?!api/auth/login|_next/static|_next/image|favicon.ico|login).*)"] }, "middleware", 0, rq], 99446);
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!api\\/auth\\/login|_next\\/static|_next\\/image|favicon.ico|login).*))(\\\\.json)?[\\/#\\?]?$"] }];
...
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge/chunks/node_modules_next_dist_esm_build_templates_edge-wrapper_0a9gg_0.js", "server/edge/chunks/[root-of-the-server]__0_lzsr-._.js", "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_09_s2fq.js"], "name": "middleware", "page": "/", "entrypoint": "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_09_s2fq.js", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!api\\/auth\\/login|_next\\/static|_next\\/image|favicon.ico|login).*))(\\\\.json)?[\\/#\\?]?$", "originalSource": "/((?!api/auth/login|_next/static|_next/image|favicon.ico|login).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "5WkHjgGHqNnL6WrCAy_lO", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "Sik/8mYOvT1BeDtvdiqkdfifOcpkKpUnwwb86/mKNVE=", "__NEXT_PREVIEW_MODE_ID": "5881a938b393fc8a6970c6ede11ffb30", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "66f9de353ada3643fa392c93b477940d92673255d508710562f4d15445c64905", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "db68961650de5c783e0a26aae9493fceadeb9ea3000ec267069f81bb9860188c" } } }, "sortedMiddleware": ["/"], "functions": {} };
var AppPathRoutesManifest = { "/(dashboard)/dashboard/page": "/dashboard", "/(dashboard)/development/page": "/development", "/(dashboard)/expenses/page": "/expenses", "/(dashboard)/houses/page": "/houses", "/(dashboard)/maintenance/dues/page": "/maintenance/dues", "/(dashboard)/maintenance/page": "/maintenance", "/(dashboard)/profile/page": "/profile", "/(dashboard)/reports/page": "/reports", "/(dashboard)/residents/page": "/residents", "/(dashboard)/users/page": "/users", "/_global-error/page": "/_global-error", "/_not-found/page": "/_not-found", "/api/auth/change-password/route": "/api/auth/change-password", "/api/auth/login/route": "/api/auth/login", "/api/auth/logout/route": "/api/auth/logout", "/api/auth/me/route": "/api/auth/me", "/api/cron/generate-dues/route": "/api/cron/generate-dues", "/api/dashboard/route": "/api/dashboard", "/api/development/contributions/route": "/api/development/contributions", "/api/development/events/route": "/api/development/events", "/api/expenses/[id]/route": "/api/expenses/[id]", "/api/expenses/categories/route": "/api/expenses/categories", "/api/expenses/route": "/api/expenses", "/api/houses/[id]/route": "/api/houses/[id]", "/api/houses/route": "/api/houses", "/api/maintenance/dues/route": "/api/maintenance/dues", "/api/maintenance/payments/route": "/api/maintenance/payments", "/api/receipts/route": "/api/receipts", "/api/reports/route": "/api/reports", "/api/residents/[id]/route": "/api/residents/[id]", "/api/residents/route": "/api/residents", "/api/users/[id]/route": "/api/users/[id]", "/api/users/route": "/api/users", "/favicon.ico/route": "/favicon.ico", "/login/page": "/login", "/page": "/" };
