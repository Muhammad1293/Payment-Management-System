...
const { id } = await params;
  ...
  try {
    ...
    const allowed = ['house_number', 'num_floors', 'notes',
      'dev_charge_status', 'elec_charge_status', 'gas_charge_status',
      'dev_charge_paid_at', 'elec_charge_paid_at', 'gas_charge_paid_at',
      'dev_charge_amount', 'elec_charge_amount', 'gas_charge_amount'];
